		...
		case ForzaVersion.Two:
		{
			...
			if (glassVertexCount > 0)
			{
				...
				for (int num9 = 0; num9 < glassVertexCount; num9++)
				{
					...
					reference = new ForzaVertex(ForzaVersion.Two, ForzaVertexType.Car, Stream, glassVertexSize);
				}
			}
			Stream.Position += 12L;
			...
			if (bodyVertexCount > 0)
			{
				...
				for (int num10 = 0; num10 < bodyVertexCount; num10++)
				{
					...
					reference2 = new ForzaVertex(ForzaVersion.Two, ForzaVertexType.Car, Stream, bodyVertexSize);
				}
			}
