...
class ForzaMesh:
    def __init__(self, name: str, material_name: str, indices: list[int], vertices: list[ForzaVertex], transform, model_index = None, textures = None, shader_filenames = None):
        self.name = name
