...
namespace ForzaStudioWinUI.Forza
{
    public class ForzaCarSubSection
    {
        ...
        public ForzaCarSubSection(ForzaCarSection parentSection)
        {
            ...
            if (parentSection.Parent.Version == ForzaVersion.FM2)
            {
            ...
            else if (parentSection.Parent.Version == ForzaVersion.FM3 || parentSection.Parent.Version == ForzaVersion.FM4)
            {
                Utilities.AssertEquals(Stream.ReadUInt32(), 3u);
                Indices = Utilities.ReadIndices(Stream, Stream.ReadInt32(), Stream.ReadInt32());
                Stream.Position += 4L;
            }
            else if (parentSection.Parent.Version == ForzaVersion.FH1)
            {
